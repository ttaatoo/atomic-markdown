...
- **WYSIWYG via selection, not a Word ribbon.** A compact CodeMirror tooltip format bar appears when text is selected in edit mode. It hides when the selection collapses or in reading mode. Keyboard shortcuts still format with no chrome on screen.
