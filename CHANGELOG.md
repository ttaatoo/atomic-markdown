...
- Selection bar QA: show when the editor DOM still owns the selection (`hasFocus` flicker / `coordsAtPos` null no longer hide it); refresh on mouseup, shift-selection keyup, and `selectionchange`; z-index 50.
